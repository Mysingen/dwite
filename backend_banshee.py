...
'''Content management backend that queries a Banshee database for artists,
   albums, and tracks. It's buggy and causes weird behaviour in playback and
   menu navigation. No further development planned.'''
